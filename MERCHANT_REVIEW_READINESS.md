...
- 판매 대상: 배송이 없는 PDF 전자책 4종, 각 19,000원
...
공개 고객센터 번호는 사이트·정책·양사 신청서에서 `070-4715-6450`으로 통일한다.
...
- 홈/상품 4종: `/`, `/codex`, `/career`, `/jane`, `/consciousness`
- 결제 및 제공: `/payment`
- 이용약관: `/terms`
- 개인정보처리방침: `/privacy`
- 교환·환불정책: `/refund`
...
비밀값은 Vercel 프로젝트 환경변수에만 넣고 Git, 신청 문서, 화면 캡처에 기록하지 않는다.
