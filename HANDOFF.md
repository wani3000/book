...
네이버 로그인과 약관 동의, 결제형 가맹점 선택, 사업자 정보·대표자 정보·공개 사업장 주소 입력까지 완료해 신청서 47.5% 단계에 도달했다. 매출 요건은 사실대로 선택했고, 조건 확인 없이 신청을 이어가는 공식 경로를 사용했다. 대표 담당자를 대표자와 동일인으로 설정하고 업무용 이메일과 일반 전화번호를 입력했다. 실제 휴대전화 번호와 SMS 인증이 필요하다.
