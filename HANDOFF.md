...
- 최신 빌드와 자동검사 통과
- 이 인계 작업 시작 전 사이트 버전 9 공개 배포 완료(현재 변경은 새 버전으로 배포 예정)
...
이 작업 시작 전 배포 기준 커밋은 `fc940bc7ff3f894e18a6bf84a2115844b4d7b8fe`다. 이후 카카오페이 심사 준비 커밋은 Git 로그와 Sites 최신 버전에서 확인한다.
