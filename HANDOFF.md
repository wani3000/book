...
- 국내 단독 결제는 승인 속도를 우선해 카카오페이 직연동으로 결정
...
- 최신 빌드와 자동검사 통과
- 카카오페이 심사 준비가 반영된 사이트 버전 21 공개 배포 완료
...
카카오페이 심사 준비 구현 커밋은 `f7c20ae13221170bc8ac7eb4b0005143309b05be`, 배포 호환성 수정 커밋은 `e6cce6328a6c7a436a65b1fe1e1c2ba762b09538`이다. 배포 후 인계서 갱신 커밋은 Git 로그에서 확인한다.
