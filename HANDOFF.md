...
- 최종 배포 기능 커밋: `8dc1c03993eb49ed21f72796c543b317f88a6142`
- 인계 문서 커밋: `main`의 최신 Git 로그를 확인
- GitHub: `wani3000/book`, `main` 브랜치
- Sites 공개 버전: `29`
- Sites 배포 ID: `appgdep_6a5e33c675088191ac3e865ae6564649`
- 배포 상태: `succeeded`
...
최종 출시 QA와 후기 관리자 기능 기준 커밋은 `8dc1c03993eb49ed21f72796c543b317f88a6142`이다. 이후 작업은 반드시 `git pull --ff-only origin main`으로 최신 커밋을 받은 뒤 시작한다.
