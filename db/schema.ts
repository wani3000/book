...
export const members = sqliteTable("members", {
  ...
  pendingNotificationEmail: text("pending_notification_email"),
  notificationEmailTokenHash: text("notification_email_token_hash"),
  notificationEmailTokenExpiresAt: text("notification_email_token_expires_at"),
