...
공개 고객센터 전화번호까지 사이트와 약관에 반영했다. 상품 3종, 사업자정보, 이용약관과 취소·환불 규정도 준비됐다. 공식 안내에는 예상 매출이나 객단가가 내부 기준 이하인 경우 제한될 수 있다는 내용이 있으므로, 신청서에는 자체 제작 전자책의 실제 판매 구조와 19,000원 단건 가격을 사실대로 기재한다.
