...
export const metadata: Metadata = { title: "아이디어를 서비스로 바꾸는 Codex 사용법", description: "IT 초보자가 Codex로 기획, 개발, 배포, 결제, SEO와 자동화까지 완성하는 233쪽 실전 전자책.", alternates: { canonical: "/codex" }, openGraph: { title: "아이디어를 서비스로 바꾸는 Codex 사용법", images: ["/ebook-cover.png"] }, twitter: { card: "summary_large_image", images: ["/ebook-cover.png"] } };

const book: DetailBook = {
  product: "codex", category: "AI · 개발 · 생산성", title: "아이디어를 서비스로 바꾸는 Codex 사용법", subtitle: "코딩을 몰라도 폴더 생성부터 배포·결제·SEO까지 혼자 완성하는 실전 가이드", creator: "필립", cover: "/ebook-cover.png", coverWidth: 1054, coverHeight: 1492, pages: "233쪽", chapters: "50단계 실전 + 경험편 24장", level: "완전 입문", theme: "orange",
  ...
  included: ["233쪽 전체 PDF 전자책", "50개 압축형 Codex 실행 카드", "하나의 예약 서비스로 보는 50단계", "오류 실습·완료 증거 체크리스트", "모바일 청첩장·마리에카드·아파트구구·다니엘의 바이블 사례"],
