...
export default function PrivacyPage() {
  return <PolicyPage eyebrow="PRIVACY POLICY" title="개인정보처리방침">
    ...
    <section><h2>4. 제3자 제공과 처리위탁</h2><p>회사는 원칙적으로 이용자의 개인정보를 동의 없이 제3자에게 제공하지 않습니다. 서비스 운영을 위해 Google(로그인), 카카오페이(결제), Cloudflare 및 OpenAI Sites(웹 호스팅·데이터 저장) 서비스를 이용하며, 각 사업자는 해당 업무 수행에 필요한 범위에서 정보를 처리할 수 있습니다. 해외 이전이 발생하는 서비스의 구체적인 이전 국가·항목·시점·보유기간은 실제 운영 설정 확정 후 이 방침에 고지합니다.</p></section>
