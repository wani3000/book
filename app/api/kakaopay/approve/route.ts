...
import { notifyPaymentCompleted, notifyPaymentFailed } from "@/app/notifications/events";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    await notifyPaymentCompleted(member, { orderId, title: book.title, amount: book.amount, provider: "카카오페이", purchasedAt: now });
