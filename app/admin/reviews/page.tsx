...
export default function AdminReviewsPage() {
  return <main className="account-site admin-site"><header className="account-header"><Link className="class-logo" href="/"><span className="class-logo-mark" aria-hidden="true">P</span><strong>PHILIP BOOKS</strong></Link><nav><Link href="/admin/members">회원 관리</Link><Link href="/mypage">마이페이지</Link><Link href="/">스토어</Link></nav></header><ReviewAdmin /><footer>관리자 전용 · 구매 번호와 후기 정보는 서비스 운영 목적으로만 사용하세요.</footer></main>;
}
