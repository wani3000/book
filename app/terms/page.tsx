...
export default function TermsPage() {
  return <PolicyPage eyebrow="TERMS OF SERVICE" title="이용약관">
    <section><h2>제1조 목적</h2><p>이 약관은 플로렌스랩(이하 “회사”)이 운영하는 다니엘의 노트에서 제공하는 전자책 판매 및 열람 서비스의 이용 조건과 회사와 이용자의 권리·의무를 정함을 목적으로 합니다.</p></section>
    <section><h2>제2조 회사 정보</h2><ul><li>상호: 플로렌스랩(Florence Lab)</li><li>사업자등록번호: 217-26-12405</li><li>통신판매업신고: 제2026-서울구로-1222호</li><li>주소: 서울특별시 구로구 고척로 49</li>{phone && <li>고객센터: {phone}</li>}<li>전자우편: florencelab@naver.com</li><li>카카오톡 상담: <a href="https://open.kakao.com/o/sOQOF6Bh" target="_blank" rel="noreferrer">상담 채널 열기</a></li></ul></section>
    ...
    <section><h2>제4조 회원 계정</h2><p>구매 내역과 전자책 열람은 회원이 인증한 Google 또는 카카오 로그인 계정에 연결됩니다. 신규 회원은 소셜 계정 인증 후 이용약관과 개인정보 수집·이용에 동의해야 가입이 완료됩니다. 같은 이메일이더라도 본인 확인 없이 서로 다른 소셜 계정을 자동 병합하지 않습니다. 탈퇴 즉시 계정과 콘텐츠 이용은 중단되며 거래 기록은 관계 법령에 따라 필요한 기간 동안 보관될 수 있습니다. 같은 소셜 계정으로 재가입하는 경우 자동 복구하지 않고 필수 동의를 다시 확인한 뒤 기존 구매 내역과 유효한 열람 권한을 연결합니다. 이용자는 본인의 계정을 안전하게 관리해야 하며, 계정을 타인에게 양도하거나 구매 콘텐츠를 불법 복제·배포해서는 안 됩니다. 자세한 절차는 <a href="/account-guide">회원·구매내역 안내</a>를 따릅니다.</p></section>
